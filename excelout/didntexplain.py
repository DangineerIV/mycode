...
## mylistdict = [ {"IP": "172.16.2.10", "driver": "arista_eos"}, {"IP": "172.16.2.20", "driver": "arista"}
...
while(True):
    mylistdict.append(get_ip_data()) # add an item to the list reutnred by get_ip_data() {"IP": value, "driver": value}
